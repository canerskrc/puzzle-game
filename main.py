...
pygame.display.set_caption('Puzzle Oyunu')
...
bg = pygame.image.load('WhatsApp Image 2022-03-19 at 17.45.44.jpeg')
bg_rect = bg.get_rect()
bg_rect.topleft = (0, 0)
...
# start screen
title_text = font_title.render('Puzzle Oyunu', True, CRIMSON)
title_rect = title_text.get_rect()
title_rect.center = (WINDOW_WIDTH // 2, WINDOW_HEIGHT // 2 - 80)

choose_text = font_content.render('Seviye Seçiniz', True, CRIMSON)
choose_rect = choose_text.get_rect()
choose_rect.center = (WINDOW_WIDTH // 2, WINDOW_HEIGHT // 2 - 20)

easy_text = font_content.render("'E' Tusuna Basiniz - Kolay (3x3)", True, ORANGE)
easy_rect = easy_text.get_rect()
easy_rect.center = (WINDOW_WIDTH // 2, WINDOW_HEIGHT // 2 + 40)

medium_text = font_content.render("'M' Tusuna Basiniz - Orta (4x4)", True, ORANGE)
medium_rect = medium_text.get_rect()
medium_rect.center = (WINDOW_WIDTH // 2, WINDOW_HEIGHT // 2 + 90)

hard_text = font_content.render("'H' Tusuna Basiniz - Zor (5x5)", True, ORANGE)
...
"""play_again_text = font_title.render('Tekrar Oyna', True, WHITE)
play_again_rect = play_again_text.get_rect()
play_again_rect.center = (WINDOW_WIDTH // 2, WINDOW_HEIGHT // 2)"""

continue_text = font_content.render('ESC Tusuna Basiniz', True, WHITE)
